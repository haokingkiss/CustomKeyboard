...
import com.hao.customkeyboard.utils.ScreenUtils;

import java.util.List;

/**
 * Created by hao on 2018/11/18.
 * Description :车牌号专用键盘
 */
...
//                        paint.setShadowLayer(0, 0, 0, 0);
                    ...
                    Drawable dr = getContext().getResources().getDrawable(R.drawable.car_keyboard_delete_bg);
                    dr.setBounds(key.x, key.y, key.x + key.width, key.y + key.height);
                    dr.draw(canvas);
